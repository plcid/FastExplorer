...
bool Render::Start() {
    Data->wc = { sizeof(Data->wc), CS_CLASSDC, WndProc, 0L, 0L, GetModuleHandle(nullptr), nullptr, nullptr, nullptr, nullptr, L"FastExplorer", nullptr };
    ::RegisterClassExW(&Data->wc);

    Data->hwnd = ::CreateWindowW(Data->wc.lpszClassName, L"FastExplorer", WS_OVERLAPPEDWINDOW, 100, 100, 1200, 750, nullptr, nullptr, Data->wc.hInstance, nullptr);
    ...
    Menu::NormalFont = io.Fonts->AddFontFromMemoryTTF(RudaMedium, sizeof RudaMedium, 25.f);
    Menu::SmallFont = io.Fonts->AddFontFromMemoryTTF(RudaMedium, sizeof RudaMedium, 20.f);
    Menu::IconFont = io.Fonts->AddFontFromMemoryTTF(&font_awesome_binary, sizeof font_awesome_binary, 20.f, &icons_config, icon_ranges);
